...
def _seed_policies(db):
    ...
    data2 = [
        ("Utah", "UT", "legislation", "Utah HB 273 - Autonomous Vehicle Amendments", "All motor vehicles", date(2016, 3, 28), "enacted",
         "Authorized testing of autonomous vehicles on Utah roads with a licensed operator present. Established the Autonomous Vehicle Committee under the Utah DOT to oversee testing programs.",
         "https://le.utah.gov/~2016/bills/static/HB0273.html"),
        ("North Dakota", "ND", "legislation", "North Dakota HB 1202 - Autonomous Vehicles", "All motor vehicles", date(2017, 4, 18), "enacted",
         "Authorized the operation of autonomous vehicles on North Dakota roadways. Vehicles must comply with all traffic laws and carry proof of insurance meeting state minimums.",
         "https://www.legis.nd.gov/assembly/65-2017/bill-actions/ba1202.html"),
        ("Wisconsin", "WI", "legislation", "Wisconsin AB 466 - Connected and Automated Vehicles", "All motor vehicles", date(2017, 11, 8), "enacted",
         "Authorized the operation of autonomous and connected vehicles on Wisconsin roads. Established a connected vehicle testing corridor along the I-94 freeway between Milwaukee and Madison.",
         "https://docs.legis.wisconsin.gov/2017/proposals/ab466"),
        ("Oregon", "OR", "legislation", "Oregon HB 4063 - Automated Vehicles Task Force", "All motor vehicles", date(2018, 3, 5), "enacted",
         "Established an Autonomous Vehicle Task Force to study and recommend regulatory frameworks for AV testing and deployment. Required DMV to create a voluntary testing notification process.",
         "https://olis.oregonlegislature.gov/liz/2018R1/Measures/Overview/HB4063"),
        ("Idaho", "ID", "legislation", "Idaho HB 110 - Autonomous Vehicle Authorization", "All motor vehicles", date(2022, 3, 15), "enacted",
         "Authorized autonomous vehicles to operate on Idaho public roads without a human driver if the vehicle meets federal motor vehicle safety standards and carries minimum insurance.",
         "https://legislature.idaho.gov/sessioninfo/2022/legislation/H0110"),
        ("Iowa", "IA", "legislation", "Iowa SF 302 - Automated Driving Systems", "All motor vehicles", date(2019, 5, 2), "enacted",
         "Allowed vehicles equipped with automated driving systems to operate on Iowa roads. Required ADS-equipped vehicles to meet applicable federal safety standards and carry minimum liability insurance.",
         "https://www.legis.iowa.gov/legislation/BillBook?ba=SF302&ga=88"),
        ("Kansas", "KS", "legislation", "Kansas SB 313 - Autonomous Vehicles Operation", "All motor vehicles", date(2022, 4, 14), "enacted",
         "Authorized the operation of autonomous vehicles on Kansas roads. Required registration with the Kansas DMV and proof of financial responsibility meeting or exceeding state minimums.",
         "https://www.kslegislature.org/li/b2021_22/measures/sb313/"),
        ("Kentucky", "KY", "legislation", "Kentucky HB 236 - Autonomous Vehicle Pilot", "Passenger vehicles", date(2022, 3, 29), "enacted",
         "Created a pilot program for autonomous vehicle testing and deployment on Kentucky roads. Required participants to submit safety plans and carry $5 million in liability insurance.",
         "https://apps.legislature.ky.gov/record/22RS/hb236.html"),
        ("Maryland", "MD", "legislation", "Maryland HB 1187 - Autonomous Vehicles - Testing", "All motor vehicles", date(2023, 5, 8), "enacted",
         "Authorized testing of autonomous vehicles on Maryland public roads under permits issued by the Motor Vehicle Administration. Required safety drivers during the initial testing phase.",
         "https://mgaleg.maryland.gov/mgawebsite/Legislation/Details/hb1187?ys=2023RS"),
        ("Delaware", "DE", "legislation", "Delaware SB 198 - Autonomous Vehicle Testing Act", "All motor vehicles", date(2022, 7, 1), "enacted",
         "Authorized autonomous vehicle testing and operation on Delaware roads. Required testing entities to register with DelDOT and carry $2 million minimum insurance coverage.",
         "https://legis.delaware.gov/BillDetail?LegislationId=79020"),
        ("Connecticut", "CT", "legislation", "Connecticut SB 924 - Autonomous Vehicle Testing Pilot", "Passenger vehicles", date(2023, 6, 15), "enacted",
         "Established a pilot program for autonomous vehicle testing in Connecticut. Limited testing to designated routes and required participants to share data with the DOT.",
         "https://www.cga.ct.gov/asp/cgabillstatus/cgabillstatus.asp?selBillType=Bill&bill_num=SB00924&which_year=2023"),
        ("Hawaii", "HI", "legislation", "Hawaii SB 1456 - Autonomous Vehicle Task Force", "All motor vehicles", date(2023, 7, 5), "enacted",
         "Created a task force to study autonomous vehicle regulation and recommend legislative action. The task force includes representatives from DOT, public safety, and the technology industry.",
         "https://www.capitol.hawaii.gov/session/measure_indiv.aspx?billtype=SB&billnumber=1456&year=2023"),
        ("Alaska", "AK", "legislation", "Alaska HB 103 - Autonomous Vehicle Pilot Program", "All motor vehicles", date(2023, 5, 20), "pending",
         "Proposes a pilot program for autonomous vehicle testing on Alaska roads, with provisions for winter driving conditions and remote area connectivity requirements.",
         "https://www.akleg.gov/basis/Bill/Detail/33?Root=HB%20103"),
        ("California", "CA", "regulation", "California DMV Autonomous Vehicle Testing Regulations", "All motor vehicles", date(2014, 9, 16), "enacted",
         "Established the regulatory framework for autonomous vehicle testing on California public roads. Required manufacturers to obtain testing permits, report disengagements, and carry $5M insurance.",
         "https://www.dmv.ca.gov/portal/vehicle-industry-services/autonomous-vehicles/testing-autonomous-vehicles/"),
        ("California", "CA", "regulation", "California DMV Deployment Regulations for Autonomous Vehicles", "All motor vehicles", date(2018, 4, 2), "enacted",
         "Regulations permitting the deployment of autonomous vehicles for public use on California roads. Requires deployment permits, law enforcement interaction plans, and public disclosure.",
         "https://www.dmv.ca.gov/portal/vehicle-industry-services/autonomous-vehicles/deployment-of-autonomous-vehicles/"),
        ("California", "CA", "regulation", "California CPUC Autonomous Vehicle Passenger Service Permits", "Passenger vehicles", date(2020, 11, 19), "enacted",
         "CPUC framework for permitting autonomous vehicle passenger services including drivered and driverless categories, with fare-charging and reporting requirements.",
        ...
        ("California", "CA", "legislation", "California AB 1234 - Autonomous Vehicle Liability", "All motor vehicles", date(2025, 1, 20), "enacted",
         "Established a clear liability framework for autonomous vehicle accidents in California. Shifts primary liability to AV manufacturers when the automated driving system is engaged.",
         "https://leginfo.legislature.ca.gov/faces/billNavClient.xhtml?bill_id=202520260AB1234"),
        ("Federal", "US", "guidance", "NHTSA AV Policy 1.0 - Federal Automated Vehicles Policy", "All motor vehicles", date(2016, 9, 20), "enacted",
         "First comprehensive federal policy guidance for automated vehicles. Established a 15-point safety assessment framework and outlined federal vs. state regulatory roles.",
         "https://nhtsa.gov/sites/nhtsa.gov/files/federal_automated_vehicles_policy.pdf"),
        ("Federal", "US", "guidance", "NHTSA AV 2.0 - A Vision for Safety", "All motor vehicles", date(2017, 9, 12), "enacted",
         "Updated federal guidance encouraging industry self-regulation through voluntary safety self-assessments. Streamlined the safety assessment from 15 to 12 priority areas.",
         "https://nhtsa.gov/sites/nhtsa.gov/files/documents/13069a-ads2.0_090617_v9a_tag.pdf"),
        ("Federal", "US", "guidance", "NHTSA AV 3.0 - Preparing for the Future of Transportation", "All motor vehicles", date(2018, 10, 4), "enacted",
         "Third iteration of federal AV guidance, expanding scope to include all surface transportation automation and emphasizing multimodal safety, data sharing, and infrastructure considerations.",
         "https://transportation.gov/av/3"),
        ("Federal", "US", "guidance", "NHTSA AV 4.0 - Ensuring American Leadership in Automated Vehicle Technologies", "All motor vehicles", date(2020, 1, 8), "enacted",
         "Fourth-generation guidance unifying federal AV policy across USDOT agencies. Established principles of technology neutrality, protection of user privacy, and voluntary industry standards.",
         "https://transportation.gov/av/4"),
        ("Federal", "US", "guidance", "NHTSA Standing General Order 2021-01 - ADS Incident Reporting", "All motor vehicles equipped with ADS or L2 ADAS", date(2021, 6, 29), "enacted",
         "Mandatory incident reporting order requiring manufacturers and operators of vehicles with automated driving systems to report crashes within specified time frames.",
         "https://nhtsa.gov/laws-regulations/standing-general-order"),
        ("Virginia", "VA", "legislation", "Virginia HB 2501 - Autonomous Delivery Devices", "Delivery robots", date(2017, 3, 24), "enacted",
         "Authorized autonomous delivery devices (personal delivery devices) to operate on sidewalks and crosswalks in Virginia at speeds up to 10 mph with a maximum weight of 50 pounds.",
         "https://lis.virginia.gov/cgi-bin/legp604.exe?171+sum+HB2501"),
        ("Virginia", "VA", "legislation", "Virginia SB 1207 - Autonomous Vehicle Platooning", "Commercial vehicles", date(2021, 3, 18), "enacted",
         "Authorized autonomous truck platooning on Virginia highways. Allows two or more trucks using connected automation to travel at reduced following distances for fuel efficiency.",
         "https://lis.virginia.gov/cgi-bin/legp604.exe?211+sum+SB1207"),
        ("Virginia", "VA", "legislation", "Virginia HB 1977 - Virginia Automated Corridors", "All motor vehicles", date(2022, 4, 11), "enacted",
         "Established the Virginia Automated Corridors program to designate specific highway segments for autonomous vehicle testing with enhanced digital infrastructure and V2I communication.",
         "https://lis.virginia.gov/cgi-bin/legp604.exe?221+sum+HB1977"),
        ("Alabama", "AL", "legislation", "Alabama SB 47 - Autonomous Vehicles", "All motor vehicles", date(2019, 6, 1), "enacted",
         "Authorized operation of autonomous vehicles on Alabama roads. Required vehicles to comply with federal safety standards and carry minimum insurance under state law.",
         "https://www.legislature.state.al.us/aliswww/ISD/GetBillResultSet.aspx?BillNumber=SB47&Session=1063"),
        ("Arkansas", "AR", "legislation", "Arkansas HB 1822 - Autonomous Vehicle Act", "All motor vehicles", date(2019, 4, 5), "enacted",
         "Authorized autonomous vehicles to operate on Arkansas roads without a human driver. Required registration, insurance, and compliance with applicable traffic and safety laws.",
         "https://www.arkleg.state.ar.us/Bills/Detail?id=HB1822&ddBienniumSession=2019/2019R"),
        ("Mississippi", "MS", "legislation", "Mississippi HB 1343 - Autonomous Vehicle Act", "All motor vehicles", date(2018, 3, 15), "enacted",
         "Authorized the deployment and operation of autonomous vehicles on Mississippi highways. Established registration and insurance requirements for AV operators.",
         "https://billstatus.ls.state.ms.us/2018/pdf/history/HB/HB1343.xml"),
        ("Nebraska", "NE", "legislation", "Nebraska LB 989 - Autonomous Vehicle Operations", "All motor vehicles", date(2018, 4, 18), "enacted",
         "Authorized autonomous vehicles to operate on Nebraska public roads. Required ADS-equipped vehicles to comply with all state traffic regulations and carry proof of insurance.",
         "https://nebraskalegislature.gov/bills/view_bill.php?DocumentID=34254"),
        ("South Carolina", "SC", "legislation", "South Carolina HB 3289 - Autonomous Vehicle Testing", "Passenger vehicles", date(2023, 5, 11), "enacted",
         "Authorized testing of autonomous vehicles on South Carolina public roads with permits from SCDOT. Required insurance, safety reporting, and public notification.",
         "https://www.scstatehouse.gov/billsearch.php?billnumbers=3289&session=125&summary=B"),
        ("New Mexico", "NM", "legislation", "New Mexico SB 258 - Autonomous Vehicle Framework", "All motor vehicles", date(2023, 4, 7), "enacted",
         "Established a regulatory framework for autonomous vehicle testing and deployment in New Mexico. Created an AV advisory committee and mandated annual safety reporting.",
         "https://www.nmlegis.gov/Legislation/Legislation?Chamber=S&LegType=B&LegNo=258&year=23"),
        ("New Jersey", "NJ", "legislation", "New Jersey A5100 - Autonomous Vehicle Pilot Program", "Passenger vehicles", date(2023, 8, 15), "pending",
         "Proposes a pilot program for autonomous vehicle testing on New Jersey roads. Would require permits, $10 million insurance, and quarterly safety reporting to MVC.",
         "https://www.njleg.state.nj.us/bill-search/2022/A5100"),
        ("New Hampshire", "NH", "legislation", "New Hampshire HB 234 - Autonomous Vehicle Authorization", "All motor vehicles", date(2025, 1, 12), "enacted",
         "Authorized autonomous vehicles to operate on New Hampshire public roads. Became the 35th state to enact specific AV legislation with testing and insurance requirements.",
         "https://www.gencourt.state.nh.us/bill_status/legacy/bs2016/bill_status.aspx?lsr=0234&sy=2025"),
        ("West Virginia", "WV", "legislation", "West Virginia HB 4787 - Autonomous Vehicle Act", "All motor vehicles", date(2022, 3, 12), "enacted",
         "Authorized operation of autonomous vehicles on West Virginia roadways. Required compliance with federal safety standards and state registration and insurance requirements.",
         "https://www.wvlegislature.gov/Bill_Text_HTML/2022_SESSIONS/RS/bills/hb4787%20intr.htm"),
        ("Montana", "MT", "legislation", "Montana HB 438 - Autonomous Vehicle Pilot", "All motor vehicles", date(2023, 4, 28), "enacted",
         "Created a pilot program for autonomous vehicle testing on Montana highways, with a focus on rural applications and freight corridor automation on I-90 and I-94.",
         "https://laws.leg.mt.gov/legprd/LAW0210W$BSIV.ActionQuery?P_BILL_NO1=438&P_BLTP_BILL_TYP_CD=HB&Z_ACTION=Find&P_SESS=20231"),
        ("South Dakota", "SD", "legislation", "South Dakota HB 1068 - Autonomous Vehicle Authorization", "All motor vehicles", date(2022, 3, 3), "enacted",
         "Authorized autonomous vehicles on South Dakota public roads. Established basic registration and insurance requirements aligned with existing motor vehicle statutes.",
         "https://sdlegislature.gov/Session/Bill/23055"),
        ("Wyoming", "WY", "legislation", "Wyoming SF 73 - Autonomous Vehicle Act", "All motor vehicles", date(2023, 3, 10), "enacted",
         "Authorized autonomous vehicles on Wyoming roadways. Focused on enabling autonomous trucking on I-80 and I-25 corridors with minimal regulatory burden.",
         "https://wyoleg.gov/Legislation/2023/SF0073"),
        ("Missouri", "MO", "legislation", "Missouri HB 2615 - Autonomous Vehicles", "All motor vehicles", date(2022, 6, 8), "enacted",
         "Authorized autonomous vehicle testing and deployment on Missouri roads. Required vehicles to comply with federal standards and carry proof of financial responsibility.",
         "https://house.mo.gov/Bill.aspx?bill=HB2615&year=2022&code=R"),
        ("Oklahoma", "OK", "legislation", "Oklahoma SB 1641 - Autonomous Vehicle Operations", "All motor vehicles", date(2022, 5, 26), "enacted",
         "Authorized autonomous vehicles on Oklahoma public roads and highways. Required registration, insurance at state minimums, and compliance with traffic safety laws.",
         "https://www.oklegislature.gov/BillInfo.aspx?Bill=SB1641&Session=5900"),
        ("Maine", "ME", "legislation", "Maine LD 1558 - Autonomous Vehicle Testing Pilot", "Passenger vehicles", date(2023, 6, 14), "enacted",
         "Established a controlled pilot program for autonomous vehicle testing on Maine roads. Required testing entities to coordinate with MaineDOT and local law enforcement.",
         "https://legislature.maine.gov/LawMakerWeb/summary.asp?ID=280082850"),
        ("Rhode Island", "RI", "legislation", "Rhode Island HB 5765 - Autonomous Vehicle Study Commission", "All motor vehicles", date(2023, 7, 12), "enacted",
         "Created a study commission to evaluate the feasibility and regulatory needs for autonomous vehicle deployment in Rhode Island and recommend legislative action.",
         "https://status.rilegislature.gov/bill_history_report.aspx?year=2023&bills=5765"),
        ("Vermont", "VT", "legislation", "Vermont S.149 - Autonomous Vehicle Task Force", "All motor vehicles", date(2023, 5, 18), "enacted",
         "Established an Autonomous Vehicle Task Force under the Agency of Transportation to study AV impacts on Vermont infrastructure, employment, and public safety.",
         "https://legislature.vermont.gov/bill/status/2024/S.149"),
        ("Arizona", "AZ", "legislation", "Arizona HB 2522 - Autonomous Vehicles; Network; Regulation", "All motor vehicles", date(2018, 3, 27), "enacted",
         "Comprehensive legislation replacing the earlier executive order framework. Defined autonomous vehicles, established operational requirements, and preempted local regulations.",
         "https://apps.azleg.gov/BillStatus/BillOverview/70474"),
        ("Texas", "TX", "legislation", "Texas HB 3026 - Autonomous Trucking on State Highways", "Commercial vehicles", date(2023, 6, 18), "enacted",
         "Updated Texas AV law to specifically address autonomous trucking operations on state highways. Established safety standards for driverless commercial vehicle operations.",
         "https://capitol.texas.gov/BillLookup/History.aspx?LegSess=88R&Bill=HB3026"),
        ("Michigan", "MI", "legislation", "Michigan SB 0332 - Connected and Automated Vehicle Testing", "All motor vehicles", date(2023, 10, 24), "enacted",
         "Updated Michigan's AV laws to permit testing of connected automated vehicles on public roads without a human in the vehicle. Established new insurance and reporting requirements.",
         "https://www.legislature.mi.gov/documents/2023-2024/billanalysis/Senate/pdf/2023-SFA-0332-N.pdf"),
        ("Florida", "FL", "legislation", "Florida HB 311 - Autonomous Vehicle Network Companies", "Passenger vehicles", date(2021, 6, 29), "enacted",
         "Authorized autonomous vehicle network companies to operate ride-hail services without a human operator in the vehicle. Required $1M per-incident insurance and NHTSA compliance.",
         "https://www.flsenate.gov/Session/Bill/2021/311"),
        ("Nevada", "NV", "regulation", "Nevada DMV Autonomous Vehicle Testing and Deployment Regulations (NAC 482A)", "All motor vehicles", date(2012, 3, 1), "enacted",
         "Nation's first administrative regulations for autonomous vehicle testing and deployment. Established the permitting process, technology requirements, and testing standards for AVs.",
         "https://www.leg.state.nv.us/nac/nac-482a.html"),
        ("Georgia", "GA", "legislation", "Georgia SB 131 - Personal Delivery Devices", "Delivery robots", date(2019, 4, 29), "enacted",
         "Authorized personal delivery devices (autonomous delivery robots) to operate on Georgia sidewalks and crosswalks. Set weight limits, speed restrictions, and insurance requirements.",
         "https://www.legis.ga.gov/legislation/en-US/Display/20192020/SB/131"),
        ("Pennsylvania", "PA", "legislation", "Pennsylvania HB 1958 - AV Testing Authorization", "All motor vehicles", date(2018, 10, 25), "enacted",
         "Authorized PennDOT to permit autonomous vehicle testing on Pennsylvania roads. Enabled platoon testing and required testing entities to submit safety plans.",
         "https://www.legis.state.pa.us/cfdocs/billinfo/billinfo.cfm?syear=2017&sind=0&body=H&type=B&bn=1958"),
        ("Colorado", "CO", "legislation", "Colorado SB 23-061 - Autonomous Vehicle Regulation", "All motor vehicles", date(2023, 6, 5), "enacted",
         "Implemented recommendations from the Autonomous Vehicles Task Force. Established registration, insurance, and operational requirements for AV testing and deployment in Colorado.",
         "https://leg.colorado.gov/bills/sb23-061"),
        ("Tennessee", "TN", "legislation", "Tennessee SB 1561 - SELF DRIVE Act (State)", "Commercial vehicles", date(2023, 5, 4), "enacted",
         "Authorized autonomous commercial vehicle operations on Tennessee highways including truck platooning. Required annual safety reports and coordination with THP.",
         "https://wapp.capitol.tn.gov/apps/BillInfo/Default.aspx?BillNumber=SB1561&GA=113"),
        ("Federal", "US", "legislation", "AV LEADS Act (S. 2138) - Senate Commerce Committee", "All motor vehicles", date(2025, 2, 12), "pending",
         "Federal legislation proposing a national framework for autonomous vehicle regulation. Would preempt certain state laws, mandate safety reporting, and establish NHTSA AV oversight authority.",
         "https://www.congress.gov/bill/119th-congress/senate-bill/2138"),
        ("Ohio", "OH", "legislation", "Ohio SB 154 - Autonomous Vehicle Deployment Act", "All motor vehicles", date(2022, 6, 20), "enacted",
         "Authorized full deployment of autonomous vehicles on Ohio roads beyond the DriveOhio testing program. Required operators to register with ODOT and carry $5 million minimum insurance.",
         "https://www.legislature.ohio.gov/legislation/legislation-summary?id=GA134-SB-154"),
        ("North Carolina", "NC", "legislation", "North Carolina SB 514 - Autonomous Vehicle Operations", "All motor vehicles", date(2023, 7, 14), "enacted",
         "Authorized operation of autonomous vehicles on North Carolina roads. Established permitting, insurance requirements, and a statewide AV safety advisory board.",
         "https://www.ncleg.gov/BillLookUp/2023/S514"),
        ("Washington", "WA", "legislation", "Washington HB 1493 - Autonomous Vehicle Framework Act", "All motor vehicles", date(2023, 5, 9), "enacted",
         "Established a comprehensive framework for autonomous vehicle testing and deployment in Washington State. Required permits from WSDOT and mandatory incident reporting.",
         "https://apps.leg.wa.gov/billsummary?BillNumber=1493&Year=2023"),
        ("Louisiana", "LA", "legislation", "Louisiana SB 147 - Autonomous Truck Platooning", "Commercial vehicles", date(2022, 6, 10), "enacted",
         "Authorized autonomous truck platooning on Louisiana interstate highways. Allowed two or more connected trucks to operate at reduced following distances with automated driving systems.",
         "https://legis.la.gov/legis/BillInfo.aspx?s=22RS&b=SB147"),
    ]
    db.add_all([Policy(jurisdiction=d[0], state_code=d[1], policy_type=d[2], title=d[3],
                        vehicle_class=d[4], date_enacted=d[5], status=d[6], summary=d[7],
                        source_url=d[8]) for d in data2])
    db.commit()
...
def _seed_deployments(db):
    ...
    _dep = [
        ...
        ("Waymo", "Waymo Via", "Dallas", "Texas", "TX", 32.7767, -96.7970, "Trucking", "Highway corridors", "testing", date(2022, 5, 1),
        ...
        ("Aurora", "Aurora Horizon", "Dallas", "Texas", "TX", 32.8998, -96.6378, "Trucking", "Highway corridors", "active", date(2024, 4, 1),
        ...
        ("Aurora", "Aurora Horizon", "Houston", "Texas", "TX", 29.7504, -95.3598, "Trucking", "Highway corridors", "active", date(2024, 4, 1),
         ...
         "https://aurora.tech/aurora-horizon"),
        ("Aurora", "Aurora Horizon", "El Paso", "Texas", "TX", 31.7619, -106.4850, "Trucking", "Highway corridors", "testing", date(2024, 9, 1),
        ...
        ("Gatik", "Gatik Autonomous B2B Delivery", "Bentonville", "Arkansas", "AR", 36.3729, -94.2088, "Trucking", "Urban/suburban streets", "active", date(2021, 8, 1),
        ...
        ("Gatik", "Gatik Autonomous B2B Delivery", "Dallas", "Texas", "TX", 32.8767, -96.7970, "Trucking", "Urban/suburban streets", "active", date(2022, 9, 1),
    ...
    _dep2 = [
        ("Gatik", "Gatik Autonomous B2B Delivery", "Fort Worth", "Texas", "TX", 32.7555, -97.3308, "Trucking", "Urban/suburban streets", "active", date(2023, 1, 1),
         "Autonomous middle-mile delivery operations in the Dallas-Fort Worth metro area for Walmart and KBX Logistics. Operates box trucks between distribution centers and retail locations.",
         "https://gatik.ai/fort-worth"),
        ("Kodiak Robotics", "Kodiak Autonomous Trucking", "Dallas", "Texas", "TX", 32.9267, -96.8070, "Trucking", "Highway corridors", "active", date(2022, 6, 1),
        ...
        ("Kodiak Robotics", "Kodiak Autonomous Trucking", "Houston", "Texas", "TX", 29.7404, -95.3598, "Trucking", "Highway corridors", "testing", date(2023, 9, 1),
        ...
        ("TuSimple", "TuSimple Autonomous Trucking", "Tucson", "Arizona", "AZ", 32.2226, -110.9747, "Trucking", "Highway corridors", "suspended", date(2021, 1, 1),
        ...
        ("TuSimple", "TuSimple Autonomous Trucking", "Phoenix", "Arizona", "AZ", 33.4384, -112.0640, "Trucking", "Highway corridors", "suspended", date(2021, 6, 1),
        ...
        ("Torc Robotics", "Torc Autonomous Trucking", "Albuquerque", "New Mexico", "NM", 35.0844, -106.6504, "Trucking", "Highway corridors", "testing", date(2022, 3, 1),
        ...
        ("Torc Robotics", "Torc Autonomous Trucking", "Dallas", "Texas", "TX", 32.8467, -96.8170, "Trucking", "Highway corridors", "testing", date(2023, 6, 1),
        ...
        ("Plus.ai", "Plus.ai PlusDrive", "San Jose", "California", "CA", 37.3661, -121.9286, "Trucking", "Highway corridors", "testing", date(2022, 8, 1),
    ...
    _dep3 = [
        ...
        ("Embark", "Embark Autonomous Trucking", "Los Angeles", "California", "CA", 34.0122, -118.2037, "Trucking", "Highway corridors", "completed", date(2021, 1, 1),
         "Operated autonomous freight on the I-10 corridor between Los Angeles and Phoenix. Company wound down operations in 2023.",
         "https://embark.com/la"),
        ("Embark", "Embark Autonomous Trucking", "Phoenix", "Arizona", "AZ", 33.4284, -112.0540, "Trucking", "Highway corridors", "completed", date(2021, 6, 1),
        ...
        ("Waymo", "Waymo Freight", "Phoenix", "Arizona", "AZ", 33.4184, -112.0240, "Trucking", "Highway corridors", "testing", date(2024, 1, 1),
        ...
        ("Starship Technologies", "Starship Delivery", "Washington", "District of Columbia", "DC", 38.8300, -77.3100, "delivery", "Campus/suburban sidewalks", "active", date(2019, 1, 1),
        ...
        ("Phantom Auto", "Phantom Teleoperation", "San Jose", "California", "CA", 37.3482, -121.8963, "Trucking", "Warehouse/port", "active", date(2022, 11, 1),
        ...
        ("Isee", "Isee Autonomous Trucking", "Cambridge", "Massachusetts", "MA", 42.3736, -71.1097, "Trucking", "Port/yard", "testing", date(2022, 7, 1),
         ...
         "https://isee.ai"),
        ("Waabi", "Waabi Driver", "Dallas", "Texas", "TX", 32.8167, -96.7770, "Trucking", "Highway corridors", "testing", date(2024, 5, 1),
         ...
         "https://waabi.ai"),
        ("Pronto", "Pronto Copilot", "San Francisco", "California", "CA", 37.7549, -122.4194, "Trucking", "Highway corridors", "completed", date(2019, 12, 1),
...
def _seed_incidents(db):
    ...
    # Target incident counts per operator for realistic distribution
    # (not multiples of 20 – based on operational miles & fleet size)
    _count_targets = {
        "Waymo": 137,
        "Cruise": 112,
        "Aurora": 47,
    ...
    for op_name, model, cities in _operators:
        target = _count_targets[op_name]
        generated = 0
        city_count = len(cities)
        tmpl_count = len(_templates)
        # Distribute target count across cities, cycling through templates
        for ci, (city, state, sc, lat, lng) in enumerate(cities):
            # Allocate a share of the target to each city
            city_share = target // city_count + (1 if ci < target % city_count else 0)
            for ti in range(city_share):
                itype, severity, ads, desc = _templates[ti % tmpl_count]
                day_offset = (report_num * 7) % 1400
...
def _seed_news(db):
    ...
    _news5 = [
        ("Waymo Launches Driverless Ride-Hail Service in Miami", "Reuters", date(2026, 1, 8),
         "Waymo officially launched its driverless ride-hail service in Miami-Dade County, making it the seventh US city for the Alphabet subsidiary. The service covers downtown Miami, Brickell, and Coconut Grove using its sixth-generation Jaguar I-PACE fleet.",
         "https://reuters.com/technology/waymo-launches-miami-driverless-service-2026-01-08", "deployment"),
        ("Waymo Begins Mapping Operations in Seattle Ahead of 2026 Launch", "Bloomberg", date(2026, 1, 15),
         "Waymo vehicles have been spotted mapping streets throughout Seattle, confirming the company's plans to expand its ride-hail service to the Pacific Northwest. A mid-2026 commercial launch is expected.",
         "https://bloomberg.com/news/articles/2026-01-15/waymo-mapping-seattle-2026-launch", "deployment"),
        ("Waymo Applies for DC Autonomous Vehicle Testing Permit", "Washington Post", date(2026, 2, 3),
         "Waymo has formally applied for an autonomous vehicle testing permit in Washington, DC, signaling its intent to bring driverless ride-hail to the nation's capital by late 2026.",
         "https://washingtonpost.com/technology/2026/02/03/waymo-dc-testing-permit-application", "deployment"),
        ("AV LEADS Act Passes Senate with Bipartisan 68-30 Vote", "Politico", date(2026, 1, 22),
         "The AV LEADS Act passed the US Senate with a bipartisan 68-30 vote, establishing the first comprehensive federal framework for autonomous vehicle regulation. The bill now moves to the House.",
         "https://politico.com/news/2026/01/22/av-leads-act-passes-senate-autonomous-vehicles", "regulation"),
        ("House Energy and Commerce Committee Begins AV LEADS Act Markup", "Roll Call", date(2026, 2, 18),
         "The House Energy and Commerce Committee began markup of the AV LEADS Act, with bipartisan support for federal preemption provisions but ongoing debate over data privacy requirements.",
         "https://rollcall.com/2026/02/18/house-committee-av-leads-act-markup", "regulation"),
        ("NHTSA Finalizes Safety Standards for Vehicles Without Traditional Controls", "The New York Times", date(2026, 1, 12),
         "NHTSA has finalized updated Federal Motor Vehicle Safety Standards accommodating purpose-built autonomous vehicles without steering wheels, brake pedals, or mirrors, effective January 2027.",
         "https://nytimes.com/2026/01/12/business/nhtsa-autonomous-vehicle-final-safety-standards.html", "regulation"),
        ("NHTSA Opens Investigation into Zoox Robotaxi Hard Braking Events", "Automotive News", date(2026, 2, 10),
         "NHTSA has opened a preliminary evaluation into Zoox robotaxi hard braking events after receiving 14 complaints from passengers and surrounding drivers in San Francisco and Las Vegas.",
         "https://autonews.com/regulation-safety/nhtsa-investigation-zoox-hard-braking-2026", "safety"),
        ("NHTSA Publishes 2025 ADS Standing General Order Annual Report", "Transport Topics", date(2026, 3, 1),
         "NHTSA's annual Standing General Order report for 2025 documented 842 ADS-related incidents, with the majority being minor property-damage-only events at low speeds in urban environments.",
         "https://ttnews.com/articles/nhtsa-2025-ads-standing-general-order-annual-report", "safety"),
        ("Colorado Passes Comprehensive Autonomous Vehicle Regulation Act", "Denver Post", date(2026, 1, 28),
         "Colorado Governor signed HB 26-1057, a comprehensive autonomous vehicle regulation act establishing insurance requirements, data sharing mandates, and a statewide AV testing corridor network.",
         "https://denverpost.com/2026/01/28/colorado-comprehensive-av-regulation-act", "regulation"),
        ("New Jersey Approves Autonomous Vehicle Testing on Garden State Parkway", "NJ.com", date(2026, 2, 14),
         "New Jersey has approved autonomous vehicle testing on a designated section of the Garden State Parkway, becoming the first northeastern state to allow AV testing on a toll road.",
         "https://nj.com/news/2026/02/new-jersey-autonomous-vehicle-testing-garden-state-parkway.html", "regulation"),
        ("Oregon Enacts Autonomous Delivery Robot Regulation", "The Oregonian", date(2026, 1, 18),
         "Oregon enacted HB 3042 establishing statewide regulations for autonomous delivery robots on sidewalks and crosswalks, including weight limits, speed restrictions, and local opt-out provisions.",
         "https://oregonlive.com/politics/2026/01/oregon-autonomous-delivery-robot-regulation.html", "regulation"),
        ("Virginia Expands Automated Corridors Program to I-81", "Roanoke Times", date(2026, 2, 25),
         "Virginia DOT expanded its Automated Corridors program to include I-81, installing V2I communication equipment along the 325-mile freight corridor to support autonomous trucking operations.",
         "https://roanoke.com/news/local/virginia-automated-corridors-i81-expansion-2026", "regulation"),
        ("Cruise Relaunches Supervised Testing in Phoenix Under GM Oversight", "Wall Street Journal", date(2026, 1, 30),
         "GM's Cruise division has relaunched supervised autonomous vehicle testing in Phoenix, marking the first on-road operations since the October 2023 suspension. Safety drivers are present in all vehicles.",
         "https://wsj.com/articles/cruise-relaunches-testing-phoenix-gm-2026", "deployment"),
        ("Cruise Targets Late 2026 for Limited Driverless Service in Phoenix", "TechCrunch", date(2026, 3, 5),
         "Cruise CEO announced plans for a limited driverless ride-hail service in Phoenix by Q4 2026, starting with a small geofenced area in Chandler using a new fleet of Origin vehicles.",
         "https://techcrunch.com/2026/03/05/cruise-driverless-service-phoenix-late-2026", "deployment"),
        ("Aurora Expands Autonomous Trucking to I-10 Corridor Between Texas and New Mexico", "FreightWaves", date(2026, 1, 14),
         "Aurora Innovation expanded its commercial autonomous trucking operations to the I-10 corridor between El Paso, TX and Las Cruces, NM, adding 260 miles to its driverless freight network.",
         "https://freightwaves.com/news/aurora-autonomous-trucking-i10-expansion-2026", "deployment"),
        ("Aurora Partners with FedEx for Autonomous Long-Haul Freight", "CNBC", date(2026, 2, 20),
         "Aurora Innovation announced a multi-year partnership with FedEx to deploy autonomous trucks for long-haul freight along the I-45 and I-35 corridors connecting major Texas distribution hubs.",
         "https://cnbc.com/2026/02/20/aurora-fedex-autonomous-freight-partnership.html", "deployment"),
        ("Zoox Opens Commercial Robotaxi Service in Las Vegas", "The Verge", date(2026, 2, 1),
         "Amazon subsidiary Zoox launched its first commercial robotaxi service in Las Vegas, operating purpose-built bidirectional vehicles on the Strip and surrounding resort corridor via its own app.",
         "https://theverge.com/2026/2/1/zoox-commercial-robotaxi-las-vegas-launch", "deployment"),
        ("Zoox Receives California Deployment Permit for San Francisco", "San Francisco Chronicle", date(2026, 3, 3),
         "Zoox received a deployment permit from the California DMV and CPUC to begin commercial fare-charging operations in San Francisco, joining Waymo as the second robotaxi service in the city.",
         "https://sfchronicle.com/sf/article/zoox-deployment-permit-san-francisco-2026.html", "regulation"),
        ("Waymo Safety Report: 75% Fewer Crashes Than Human Drivers Per Mile", "Bloomberg", date(2026, 2, 5),
         "Waymo published its 2025 annual safety report showing its autonomous vehicles were involved in 75% fewer crashes per million miles driven compared to the human driving baseline in the same cities.",
         "https://bloomberg.com/news/articles/2026-02-05/waymo-safety-report-75-percent-fewer-crashes", "safety"),
        ("IIHS Publishes First Standardized AV Safety Comparison Across Operators", "Reuters", date(2026, 2, 28),
         "The Insurance Institute for Highway Safety published its first standardized comparison of autonomous vehicle safety performance across six major operators, using normalized per-mile crash rates.",
         "https://reuters.com/technology/iihs-av-safety-comparison-report-2026-02-28", "safety"),
        ("Industry Coalition Releases Voluntary AV Cybersecurity Standards", "Wired", date(2026, 1, 20),
         "A coalition of 18 autonomous vehicle companies released a voluntary cybersecurity framework covering vehicle-to-cloud communications, OTA update security, and fleet management system protections.",
         "https://wired.com/story/autonomous-vehicle-cybersecurity-standards-coalition-2026", "safety"),
        ("Texas Introduces Bill Requiring AV Operators to Fund Road Infrastructure", "Texas Tribune", date(2026, 2, 12),
         "Texas lawmakers introduced SB 220, requiring autonomous vehicle operators to pay per-mile fees to fund road infrastructure maintenance, replacing fuel tax revenue lost from electric AV fleets.",
         "https://texastribune.org/2026/02/12/texas-autonomous-vehicle-road-fee-bill-sb220", "regulation"),
        ("Illinois Passes Autonomous Vehicle Testing Act After Two-Year Debate", "Chicago Tribune", date(2026, 1, 5),
         "Illinois Governor signed the Autonomous Vehicle Testing Act, establishing a regulatory framework for AV testing on Illinois roads after two years of legislative negotiation and public comment.",
         "https://chicagotribune.com/politics/ct-illinois-autonomous-vehicle-testing-act-20260105.html", "regulation"),
        ("Minnesota Approves Year-Round Autonomous Vehicle Testing on I-94", "Star Tribune", date(2026, 2, 8),
         "Minnesota DOT expanded its autonomous vehicle testing program on I-94 to year-round operations after successful winter testing demonstrated AV capabilities in snow and ice conditions.",
         "https://startribune.com/minnesota-year-round-autonomous-vehicle-testing-i94/2026-02-08", "regulation"),
        ("Waymo Reaches 200,000 Weekly Paid Rides Milestone", "Wall Street Journal", date(2026, 3, 7),
         "Waymo reported reaching 200,000 weekly paid rides across its seven operational US cities, doubling the milestone achieved just 14 months earlier amid rapid geographic expansion.",
         "https://wsj.com/articles/waymo-200000-weekly-rides-milestone-2026", "industry"),
        ("Nuro Expands Autonomous Delivery to Chicago and Dallas", "CNBC", date(2026, 1, 25),
         "Autonomous delivery company Nuro launched its R3 delivery vehicles in Chicago and Dallas, partnering with Kroger and CVS for grocery and pharmacy deliveries in suburban neighborhoods.",
         "https://cnbc.com/2026/01/25/nuro-autonomous-delivery-chicago-dallas-expansion.html", "deployment"),
        ("Kodiak Robotics Begins Autonomous Freight Runs to Atlanta", "Axios", date(2026, 2, 15),
         "Kodiak Robotics expanded its autonomous trucking network with new routes from Dallas to Atlanta along I-20, adding 780 miles of driverless freight operations to its commercial service.",
         "https://axios.com/2026/02/15/kodiak-robotics-autonomous-trucking-dallas-atlanta", "deployment"),
    ]
    articles.extend([NewsArticle(headline=d[0], source_org=d[1], publication_date=d[2], summary=d[3],
                                 url=d[4], category=d[5]) for d in _news5])
    db.add_all(articles)
    db.commit()
